 ...
 * 1. Regular server operations (respects RLS)
 * 2. Admin operations (bypasses RLS with service role)
 * 
 * IMPORTANT: Never expose the service role client to the frontend!
 */
 ...
 * Use this for:
 * - Server Components
 * - Route Handlers that need user context
 * - Server Actions
 * 
 * @example
 * ```typescript
